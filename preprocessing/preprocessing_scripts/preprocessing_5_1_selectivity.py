...
def process_queries_selectivity_generalization(query_directory, output_dir: Path):
    ...
    try:
        ...
        for count, (query, query_name) in enumerate(tqdm(zip(queries, query_names), 
                                                        total=len(queries),
...
if __name__ == "__main__":
    ...
    QUERY_DIRECTORY_SELECTIVITY = '../../workloads/imdb_pg_dataset/job_extended/'
    OUTPUT_DIR_SELECTIVITY = Path("../../experiments/experiment5/5.1/selectivity_generalization/")
