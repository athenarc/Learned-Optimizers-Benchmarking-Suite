...
WHERE cn1.country_code = '[ca]'
    ...
    AND kt1.kind in ('movie','video movie','tv series','episode','tv movie','video game','tv mini series')
    AND kt2.kind in ('movie','video movie','tv series','episode','tv movie','video game','tv mini series')
    AND lt.link LIKE '%ed in%'
    AND mi_idx2.info < '28'
    AND t2.production_year = 2013
