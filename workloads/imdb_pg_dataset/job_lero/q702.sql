...
WHERE cct1.kind = 'cast'
    ...
    AND it2.info = 'rating'
    AND kt.kind in ('video movie','episode','episode','episode','video game','episode','video movie')
    AND mc.note not like '%1948) (Cuba) (the%'
    AND mi.info not IN ('German','4','USA:21','PFM:35 mm','Washington, District of Columbia, USA','USA:9 September 2010','Horror','Drama','Drama')
    AND mi_idx.info > '0000001112'
