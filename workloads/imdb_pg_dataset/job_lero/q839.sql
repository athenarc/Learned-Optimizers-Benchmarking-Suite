...
WHERE cn1.country_code = '[us]'
    AND it1.info = 'rating'
    AND it2.info = 'rating'
    AND kt1.kind in ('tv movie','episode','tv mini series','tv mini series','tv series')
    AND kt2.kind in ('tv movie','episode','tv mini series','tv mini series','tv series')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '6.4'
    AND t2.production_year = 1999
