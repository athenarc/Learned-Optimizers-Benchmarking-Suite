...
WHERE cn.country_code != '[pl]'
    ...
    AND k.keyword in ('fake-doctor','hypnosis','torino-scale','sesame-street','thunderbolt','native-dress','headless-corpse','kiev','presidential-candidate','almost-hit-by-a-truck')
