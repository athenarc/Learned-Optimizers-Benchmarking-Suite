...
WHERE cct1.kind = 'complete'
    ...
    AND k.keyword in ('p-51','running-mate','reference-to-cary-grant','1500s','teenage-crush','freighter','apprentice','indian-woman')
    AND kt.kind in ('tv mini series','movie','movie','movie','tv mini series','tv mini series')
    AND mi.note like '%%'
    AND mi.info like '%n%'
