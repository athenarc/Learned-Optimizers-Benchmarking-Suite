...
WHERE cct1.kind = 'crew'
    ...
    AND k.keyword in ( 'bomb','multiple-storyline','kent-england','begins-with-a-quotation','homing-beacon','jazz-guitarist','father-disapproves-of-girlfriend','prosecutor','ear','interracial-romance' )
