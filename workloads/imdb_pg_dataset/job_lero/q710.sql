...
WHERE cn.country_code != '[ca]'
    ...
    AND k.keyword = 'veterinary-clinic'
    AND lt.link LIKE '%s%'
    AND mc.note IS NULL
    AND mi.info IN ('USA:21 January 2013','UK','Spanish','France','UK:12 July 2011','Japanese','USA:24 September 2007')
    AND t.production_year BETWEEN 1989
    AND 2010
