...
WHERE cct1.kind = 'crew'
    ...
    AND it2.info = 'rating'
    AND kt.kind in ('movie','tv mini series','movie','tv movie','video movie','video game','tv mini series','movie')
    AND mc.note not like '%05) (worldwide%'
    AND mi.info not IN ('Mono','USA','Netherlands:12','Documentary')
    AND mi_idx.info > '16'
