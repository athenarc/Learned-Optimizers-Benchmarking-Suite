...
WHERE cn1.country_code = '[us]'
    AND it1.info = 'rating'
    AND it2.info = 'rating'
    AND kt1.kind in ('movie','tv mini series','tv mini series','tv mini series','episode','video movie','movie','tv movie','video movie','video game')
    AND kt2.kind in ('movie','tv mini series','tv mini series','tv mini series','episode','video movie','movie','tv movie','video movie','video game')
    AND lt.link LIKE '%atu%'
    AND mi_idx2.info < '6.9'
    AND t2.production_year = 1996
