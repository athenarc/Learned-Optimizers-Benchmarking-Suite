...
WHERE cn.country_code != '[pl]'
    ...
    AND k.keyword in ('flower-girl','boyfriend-girlfriend-relationship','cinderella-story','turkish-independence-war','man-hitting-wife','luigi','child-molestation','training')
