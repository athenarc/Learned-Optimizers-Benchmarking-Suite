...
WHERE cn1.country_code = '[us]'
    AND it1.info = 'rating'
    AND it2.info = 'rating'
    AND kt1.kind in ('video game','video game','episode','video game','tv series')
    AND kt2.kind in ('video game','video game','episode','video game','tv series')
    AND lt.link LIKE '%ll%'
    AND mi_idx2.info < '7.6'
    AND t2.production_year = 1987
