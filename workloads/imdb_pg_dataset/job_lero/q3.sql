...
WHERE cct1.kind = 'cast'
    ...
    AND k.keyword in ( 'neglect','unhappiness','illegitimate-son','ignoring-telephone','black-and-white','bitten-in-the-face','10,000-b.c.','knocked-out-with-gun-butt','absorbing-power','sleeping-with-a-light-on' )
    AND kt.kind = 'episode'
