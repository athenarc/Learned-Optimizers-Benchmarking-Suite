...
WHERE ci.note in ( '(location scout)','(executive producer)','(director of photography)','(uncredited)','(scenario)','(continuity)','(executive vice president: creative affairs)','(office runner)' )
    ...
    AND n.name like '%Ang%'
    AND rt.role = 'actress'
    AND t.production_year between 1953
    AND 2010
