...
WHERE cct1.kind = 'crew'
    ...
    AND ( chn.name like '%arket%'
    OR chn.name like '%arket%' )
    AND it2.info = 'rating'
    AND k.keyword in ( 'cognitive-interview','murder-for-profit','drug-smuggling','prize','cornelius-vanderbilt','rape-attempt','clubber' )
    AND kt.kind = 'movie'
