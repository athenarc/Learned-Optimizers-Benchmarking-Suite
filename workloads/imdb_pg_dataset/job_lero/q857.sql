...
WHERE ci.note in ('(as Andrew)','(locations)','(set production assistant)','(producer)','(technical coordinator)')
    AND it1.info = 'plot'
    AND it2.info = 'votes'
    AND k.keyword in ('medicine-cabinet','political-rally','television-flop','vehicular-homicide','human-rights-lawyer','mistaken-sex-scene','cattle','13th-century','little-person')
