...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('sos','reference-to-sonny-and-cher','customer-service','abortionist','moving-to-city','cartoon-gorilla','hotel-lobby','thermos','strong-man','tangiers')
    AND kt.kind in ('video movie','video movie','episode','tv mini series','tv mini series','movie','tv series','tv movie')
    AND mi.note like '%lm %'
    AND mi.info like '%%'
