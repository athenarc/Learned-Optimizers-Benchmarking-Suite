...
WHERE cn1.country_code = '[es]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('tv movie','episode','tv series','movie','video game','movie','movie','episode','episode')
    AND kt2.kind in ('tv movie','episode','tv series','movie','video game','movie','movie','episode','episode')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '8'
