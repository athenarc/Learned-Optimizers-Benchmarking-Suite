...
WHERE cn1.country_code = '[us]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('tv mini series','movie','tv movie','video movie','episode','movie','episode','tv series','tv movie')
    AND kt2.kind in ('tv mini series','movie','tv movie','video movie','episode','movie','episode','tv series','tv movie')
    AND lt.link LIKE '%i%'
