...
WHERE cn1.country_code = '[gb]'
    AND it1.info = 'votes distribution'
    AND it2.info = 'votes distribution'
    AND kt1.kind in ('movie','tv series','video movie','tv mini series','episode','movie','video movie','episode','episode')
    AND kt2.kind in ('movie','tv series','video movie','tv mini series','episode','movie','video movie','episode','episode')
    AND lt.link LIKE '%fe%'
    AND mi_idx2.info < '6.9'
    AND t2.production_year = 1981
