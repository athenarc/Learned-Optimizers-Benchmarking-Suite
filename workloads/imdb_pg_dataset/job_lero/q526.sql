...
WHERE cct1.kind = 'complete+verified'
    ...
    AND it1.info = 'plot'
    AND k.keyword in ('court-martial','evolution','diving','living-person-mistaken-for-dead-body','lighting-a-candle')
    AND kt.kind in ('video game','tv movie','tv mini series','movie','video movie','video game')
    AND mi.note like '%D%'
    AND mi.info like '%%'
