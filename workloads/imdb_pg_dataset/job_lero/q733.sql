...
WHERE cn.country_code != '[in]'
    ...
    AND k.keyword = 'movie-studio'
    AND lt.link LIKE '%eat%'
    AND mc.note IS NULL
    AND mi.info IN ('Short','Color','Argentina:16','Spanish','Brazil:38','OFM:35 mm','Short','UK:35','USA:47')
    AND t.production_year BETWEEN 1997
    AND 2004
