...
WHERE cn.country_code != '[pl]'
    ...
    AND k.keyword in ('knickers','giant','prosecuting-attorney','bird-cake','destroyed-evidence','space-race','horse-drawn-cart','reference-to-degas','eccentric','tied-up-while-barefoot')
