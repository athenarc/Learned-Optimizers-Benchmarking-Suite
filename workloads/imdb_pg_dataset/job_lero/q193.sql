...
WHERE cct1.kind = 'complete+verified'
    ...
    AND it1.info = 'plot'
    AND k.keyword in ('composite-bow','rope-twirling','misogyny','expired-drivers-license','fruit-salad','employer-employee-relationship','suspicious-wife','kneeling')
    AND kt.kind in ('tv movie','episode','movie','video movie','movie','tv mini series','video movie','movie')
    AND mi.note like '% %'
    AND mi.info like '%%'
