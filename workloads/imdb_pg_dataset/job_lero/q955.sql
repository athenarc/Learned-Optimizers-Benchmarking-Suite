...
WHERE cn1.country_code = '[de]'
    AND it1.info = 'votes distribution'
    AND it2.info = 'votes distribution'
    AND kt1.kind in ('tv movie','video game','tv movie','tv mini series','episode','movie','episode','video game','episode')
    AND kt2.kind in ('tv movie','video game','tv movie','tv mini series','episode','movie','episode','video game','episode')
    AND lt.link LIKE '%refer%'
    AND mi_idx2.info < '6.1'
    AND t2.production_year = 1988
