...
WHERE ci.note in ( '(creator)','(archive footage)','(production assistant)','(additional location crew: Belgium)','(voice)','(supervising producer)','(series producer)','(location manager: second unit)' )
