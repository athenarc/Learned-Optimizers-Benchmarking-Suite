...
WHERE cct1.kind = 'complete'
    ...
    AND k.keyword in ('motorcycle-race','migration','cassowary','dunking-head-in-ice-water','football-team','winchester-house','parachute','letter-read-aloud','intimacy-issues')
    AND kt.kind in ('tv mini series','episode','movie','tv series','video game')
    AND mi.note like '%%'
    AND mi.info like '%%'
