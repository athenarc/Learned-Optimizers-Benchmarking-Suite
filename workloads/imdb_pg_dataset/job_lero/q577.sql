...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('checking-heartbeat','heat-sensor','film-clips','attempted-car-theft','conquistador','stupid-victim','corporate-takeover')
    AND kt.kind in ('movie','video movie','tv series','tv mini series')
    AND mi.note like '%(%'
    AND mi.info like '%%'
