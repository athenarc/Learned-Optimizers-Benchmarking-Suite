...
WHERE cct1.kind in ('complete','crew','complete+verified','complete+verified','complete+verified','cast','crew','crew','complete')
    ...
    AND lt.link LIKE '%i%'
    AND mc.note IS NULL
    AND mi.info IN ('Comedy','English','USA:23 February 2010','French','French','USA:22 September 2003','USA:12 October 2010','Turkey','Mono','31')
    AND t.production_year between 1960
    AND 1993
