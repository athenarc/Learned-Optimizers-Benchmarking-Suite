...
WHERE cn1.country_code = '[us]'
    ...
    AND kt1.kind in ('episode','tv mini series','movie','video game','tv series','movie')
    AND kt2.kind in ('episode','tv mini series','movie','video game','tv series','movie')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '0000001112'
    AND t2.production_year = 1993
