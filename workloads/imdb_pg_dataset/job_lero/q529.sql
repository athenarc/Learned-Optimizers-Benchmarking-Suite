...
WHERE ci.note in ('(unspecified crew member)','(post producer)','(executive producer)','(assistant)','(written by)','(1996-2000)','(written by)')
    AND it1.info = 'copyright holder'
    AND it2.info = 'votes'
    AND k.keyword in ('reference-to-gary-cooper','fix-it-man','chainsaw','deserted-wife','human-resources','whoopee-cushion','eating-pigeon','nightstick','white-castle','defusing-a-bomb')
