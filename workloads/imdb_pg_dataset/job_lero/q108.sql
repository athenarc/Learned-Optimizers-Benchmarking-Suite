...
WHERE ci.note in ('(studio sequences)','(assistant accountant)')
    AND it1.info = 'LD group genre'
    AND it2.info = 'rating'
    AND k.keyword in ('landscape-painter','shot-in-the-butt','selling-cookies','gum','water-pistol','toy-cat','choreographer')
