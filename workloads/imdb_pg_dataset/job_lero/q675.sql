...
WHERE cct1.kind = 'complete'
    ...
    AND k.keyword in ('reference-to-charles-albert-horner','lawn-party','heavy-rain','riding-a-bus','revealing-movie-spoiler')
    AND kt.kind in ('tv mini series','episode','tv mini series','tv series','movie','movie','movie','tv series','tv movie')
    AND mi.note like '%%'
    AND mi.info like '%%'
