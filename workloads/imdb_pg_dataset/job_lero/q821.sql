...
WHERE cct1.kind = 'crew'
    ...
    AND kt.kind in ('video game','tv series','video movie','movie','tv series','episode','tv series','video movie','video movie')
    AND mc.note not like '%TV%'
    AND mi.info not IN ('Japan','Color','Drama','Action','English','$5,000,000','USA:27')
    AND mi_idx.info > '.....12121'
