...
WHERE ci.note in ( '(vice president: operations)','(voice)','(production assistant) (as Marie Charmaine Estrera)','(co-executive producer)','(assistant production coordinator)','(associate director)','(play)' )
