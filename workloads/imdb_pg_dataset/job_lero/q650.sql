...
WHERE cn1.country_code = '[gb]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('tv movie','episode','movie','tv movie','tv movie','tv series','tv movie')
    AND kt2.kind in ('tv movie','episode','movie','tv movie','tv movie','tv series','tv movie')
    AND lt.link LIKE '%a%'
    AND mi_idx2.info < '17'
    AND t2.production_year = 2012
