...
WHERE cn.country_code != '[fr]'
    ...
    AND k.keyword = 'secret-trapdoor'
    AND lt.link LIKE '%%'
    AND mc.note IS NULL
    AND mi.info IN ('Color','English','RAT:1.33 : 1','Silent','PCS:(anamorphic)','Massachusetts, USA','Silent','Luxor, Egypt')
    AND t.production_year BETWEEN 1910
    AND 2003
