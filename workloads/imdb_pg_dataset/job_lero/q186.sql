...
WHERE cct1.kind = 'cast'
    ...
    AND k.keyword in ( 'game-of-darts','namesake','lathe','english-football','climbing-out-a-window','dinner-guest','newspaper-review','jumping-off-moving-train','reference-to-culture-club' )
    AND kt.kind = 'movie'
