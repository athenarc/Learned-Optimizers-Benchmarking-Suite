...
WHERE ci.note in ('(written by)','(field producer)','(archive footage) (uncredited)','(as Jonas Altberg)','(production assistant)','(creator)')
    AND it1.info = 'adaption'
    AND it2.info = 'top 250 rank'
    AND k.keyword in ('interior-monologue','husband-wife-relationship','christmas-special','year-2006','family-scandal')
