...
WHERE cn.country_code != '[de]'
    ...
    AND k.keyword = 'moonlight'
    AND lt.link LIKE '%poofed%'
    AND mc.note IS NULL
    AND mi.info IN ('14','USA:4 August 2012','CAM:Panasonic AJ-HDX900','Dolby','Mono','English','Short','Color','France:90')
    AND t.production_year BETWEEN 1908
    AND 1993
