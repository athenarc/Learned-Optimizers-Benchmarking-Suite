...
WHERE cn1.country_code = '[nl]'
    ...
    AND kt1.kind in ('movie','tv series','episode','episode','movie','video game','video movie')
    AND kt2.kind in ('movie','tv series','episode','episode','movie','video game','video movie')
    AND lt.link LIKE '%e%'
    AND mi_idx2.info < '5.0'
    AND t2.production_year = 2002
