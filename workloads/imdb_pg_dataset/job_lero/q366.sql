...
WHERE cct1.kind = 'crew'
    ...
    AND kt.kind in ('tv series','tv movie','video movie','video movie','movie','tv movie','movie','movie','tv movie')
    AND mc.note not like '%a%'
    AND mi.info not IN ('Black
    AND White','Drama','English','Short','USA','OFM:35 mm','Drama')
    AND mi_idx.info > '3.0'
