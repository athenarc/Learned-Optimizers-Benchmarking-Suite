...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('poland','gang-war','sand','morning-sickness','reference-to-bruce-wayne','brushing-teeth')
    AND kt.kind in ('tv movie','video movie','tv series','episode','tv series')
    AND mi.note like '%%'
    AND mi.info like '%%'
