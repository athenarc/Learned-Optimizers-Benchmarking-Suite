...
WHERE ci.note in ('(executive producer) (as Adjanet F. Rase)','(producer)','(producer)')
    AND it1.info = 'LD release date'
    AND it2.info = 'votes'
    AND k.keyword in ('farc','albania','organ-grinder','reference-to-martha-raye','human-versus-computer','byzantine','baby-crying','reference-to-jack-daniels','correctional-officer','experimental')
