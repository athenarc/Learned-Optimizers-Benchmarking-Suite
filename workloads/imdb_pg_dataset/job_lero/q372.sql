...
WHERE cn1.country_code = '[de]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('movie','tv mini series','movie','video game','video movie','video game','tv mini series','video game','episode','tv series')
    AND kt2.kind in ('movie','tv mini series','movie','video game','video movie','video game','tv mini series','video game','episode','tv series')
    AND lt.link LIKE '%ve%'
