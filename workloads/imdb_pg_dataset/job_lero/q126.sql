...
WHERE ci.note in ( '(executive producer)','(production assistant)','(website developer)','(assistant location manager)','(voice)','(location manager)','(producer)','(script supervisor)','(executive producer)' )
    AND cn.country_code = '[us]'
    AND cn.name = 'Universal International Pictures (UI)'
