...
WHERE cn1.country_code = '[it]'
    ...
    AND kt1.kind in ('video game','tv series','tv movie','tv movie','tv series')
    AND kt2.kind in ('video game','tv series','tv movie','tv movie','tv series')
    AND lt.link LIKE '% %'
    AND mi_idx2.info < '6.1'
    AND t2.production_year = 1998
