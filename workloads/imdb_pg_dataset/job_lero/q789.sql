...
WHERE cn1.country_code = '[br]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('movie','tv movie','tv movie','video game','tv series','video movie','movie','video game')
    AND kt2.kind in ('movie','tv movie','tv movie','video game','tv series','video movie','movie','video game')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '7.8'
    AND t2.production_year = 2001
