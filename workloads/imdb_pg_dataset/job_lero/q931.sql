...
WHERE cct1.kind = 'cast'
    ...
    AND kt.kind in ('episode','tv mini series','tv series','tv movie','tv mini series','tv movie','tv movie','movie','movie','tv series')
    AND mc.note not like '%20%'
    AND mi.info not IN ('Adult','Stereo','Black
    AND White','USA','Greece','Argentina:60','Drama','Short')
    AND mi_idx.info > '0...002310'
