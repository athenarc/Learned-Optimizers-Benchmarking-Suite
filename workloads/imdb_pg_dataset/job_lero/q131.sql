...
WHERE cct1.kind = 'cast'
    ...
    AND it2.info = 'votes'
    AND kt.kind in ('movie','tv series','tv movie','video movie','tv mini series','tv mini series','video game','video movie','tv movie')
    AND mc.note not like '%) (U%'
    AND mi.info not IN ('USA:1 November 2008','English','Mystery','Mono','Singapore:G','Western','Canada:8','USA','Short')
    AND mi_idx.info > '7.7'
