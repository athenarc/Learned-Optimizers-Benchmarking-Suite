...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('shakespeare''s-king-lear','record-label','duchess','kissing-a-baby','russian-civil-war','quitting-a-job','afghanistan','treasure-chest')
    AND kt.kind in ('episode','movie','video game','video game','video movie','episode','episode','tv mini series','episode','tv series')
    AND mi.note like '%%'
    AND mi.info like '%r%'
