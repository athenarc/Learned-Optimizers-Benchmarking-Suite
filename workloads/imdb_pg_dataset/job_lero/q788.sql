...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('murder-spree','carrying-bride-across-threshold','sadness','cartoon-dog','reference-to-frank-sinatra','driven-mad','narcissistic-personality-disorder','reference-to-aristotle')
    AND kt.kind in ('tv series','video movie','movie')
    AND mi.note like '%el%'
    AND mi.info like '% : %'
