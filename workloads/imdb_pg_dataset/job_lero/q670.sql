...
WHERE cn1.country_code = '[ca]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('tv series','video game','tv mini series','video game','tv mini series','episode','episode','tv series','tv movie','tv movie')
    AND kt2.kind in ('tv series','video game','tv mini series','video game','tv mini series','episode','episode','tv series','tv movie','tv movie')
    AND lt.link LIKE '% i%'
    AND mi_idx2.info < '12'
    AND t2.production_year = 2006
