...
WHERE cct1.kind = 'crew'
    ...
    AND it1.info = 'LD release country'
    AND it2.info = 'votes'
    AND kt.kind in ('tv movie','episode','movie','tv mini series','tv series','video game','video movie')
    AND mc.note not like '%V%'
    AND mi.info not IN ('India','English','Color','RAT:1.33 : 1','Spanish','Finland','RAT:1.33 : 1','Documentary')
    AND mi_idx.info > '6.4'
