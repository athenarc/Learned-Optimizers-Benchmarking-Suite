...
WHERE ci.note in ( '(written by)','(executive producer)','(executive consultant)','(associate producer)','(voice) (uncredited)','(autocue operator)','(production assistant)','(writer)','(dialogue)' )
