...
WHERE cct1.kind = 'complete'
    ...
    AND k.keyword in ('imprisoned','energy','two-women-in-bed','slapping-child','enlisting-in-army','donut','vapor','gender-transition','exoneration')
    AND kt.kind in ('episode','episode','tv movie','tv series','tv series','tv mini series','video movie','tv mini series','video movie')
    AND mi.note like '%%'
    AND mi.info like '%%'
