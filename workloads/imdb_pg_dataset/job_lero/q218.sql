...
WHERE cn1.country_code = '[us]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('tv series','video game','episode','tv mini series','tv mini series','tv movie','video movie','video game','movie','tv series')
    AND kt2.kind in ('tv series','video game','episode','tv mini series','tv mini series','tv movie','video movie','video game','movie','tv series')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '133'
    AND t2.production_year = 1982
