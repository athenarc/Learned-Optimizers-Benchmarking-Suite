...
WHERE cn1.country_code = '[us]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('episode','tv series','episode','video game','video game','tv series','tv series','tv movie','video game','video game')
    AND kt2.kind in ('episode','tv series','episode','video game','video game','tv series','tv series','tv movie','video game','video game')
    AND lt.link LIKE '%e%'
    AND mi_idx2.info < '123'
    AND t2.production_year = 2011
