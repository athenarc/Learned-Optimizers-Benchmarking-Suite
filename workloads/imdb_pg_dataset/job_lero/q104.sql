...
WHERE cct1.kind = 'crew'
    ...
    AND k.keyword in ( 'fractured-vertebrae','burlesque-show','locked-in-a-cage','archery-lesson','mini-helicopter','emotional-breakdown','reference-to-ryan-white','changeling','rabbit' )
