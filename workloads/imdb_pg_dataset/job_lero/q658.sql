...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('gay-wedding','friend','bronze','severed-leg','cancer-treatment','vestry','watch-stopped')
    AND kt.kind in ('tv series','video movie','tv movie','video game','movie','tv series','tv movie')
    AND mi.note like '%%'
    AND mi.info like '%lo%'
