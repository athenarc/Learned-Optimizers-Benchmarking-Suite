...
WHERE cct1.kind = 'cast'
    ...
    AND it1.info = 'interviews'
    AND it2.info = 'top 250 rank'
    AND kt.kind in ('episode','tv movie','movie','tv series','video movie','tv mini series','tv movie','movie')
    AND mc.note not like '%12) (Icela%'
    AND mi.info not IN ('Color','USA:20 May 2000','Crime','UK','USA','INR 15,000,000','Dolby Digital')
    AND mi_idx.info > '8'
