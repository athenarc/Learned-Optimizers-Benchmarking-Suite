...
WHERE cct1.kind = 'crew'
    ...
    AND it1.info = 'LD number of sides'
    AND it2.info = 'votes'
    AND kt.kind in ('episode','movie','episode','video movie','tv mini series','tv mini series','video game','tv series')
    AND mc.note not like '%3) (Peru) (all me%'
    AND mi.info not IN ('OFM:35 mm','USA:28 October 2005','Color','Short','Drama')
    AND mi_idx.info > '..01112100'
