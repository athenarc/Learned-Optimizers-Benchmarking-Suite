...
WHERE ci.note in ('(producer)','(edit producer)','(production assistant)','(uncredited)','(investor)','(production coordinator)')
    AND it1.info = 'printed media reviews'
    AND it2.info = 'votes'
    AND k.keyword in ('office-space','doctor','woman-strangled-to-death','social-injustice','chocolate-chip','raining','child-nemesis')
