...
WHERE cct1.kind = 'crew'
    ...
    AND k.keyword in ( 'sex-in-chair','hiding-in-plain-sight','carbonation','recipe','darwinism','cabbage','cryogenic-suspension','reference-to-the-ritz-brothers','rivalry','life-coach' )
    AND kt.kind = 'movie'
