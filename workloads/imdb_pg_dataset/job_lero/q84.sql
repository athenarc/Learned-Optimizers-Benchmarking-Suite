...
WHERE cct1.kind = 'crew'
    AND cct2.kind != 'crew'
    AND cn.country_code != '[rs]'
    AND it1.info = 'adaption'
    AND it2.info = 'rating'
    AND kt.kind in ('movie','video movie','tv movie','tv series','tv movie','tv movie','video game','tv mini series')
    AND mc.note not like '%tralia) (video) (%'
    AND mi.info not IN ('Canada:91','Color','Czechoslovakia','CAM:Red One Camera')
    AND mi_idx.info > '101'
