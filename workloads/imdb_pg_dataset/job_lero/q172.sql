...
WHERE cct1.kind = 'cast'
    ...
    OR chn.name like '%%' )
    AND it2.info = 'votes'
    AND k.keyword in ( 'school-sport','compressor','pencil-sharpener','slap','whining','pole-the-structure','reference-to-tom-sawyer','around-the-world-in-80-days','daughter' )
    AND kt.kind = 'movie'
