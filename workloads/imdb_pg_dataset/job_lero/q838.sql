...
WHERE cn1.country_code = '[it]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('tv series','episode','video movie','tv series','tv movie','video movie','episode')
    AND kt2.kind in ('tv series','episode','video movie','tv series','tv movie','video movie','episode')
    AND lt.link LIKE '%r%'
    AND mi_idx2.info < '7'
