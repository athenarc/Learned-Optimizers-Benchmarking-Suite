...
WHERE cct1.kind = 'cast'
    ...
    AND ( chn.name like '%ig%'
    OR chn.name like '%ig%' )
    AND it2.info = 'votes'
    AND k.keyword in ( 'missing-one''s-friend','watchman','strange-love','science-fiction','timing','crossing-the-border','nazi','golf-club','ventriloquist','tear-gas-cannister' )
