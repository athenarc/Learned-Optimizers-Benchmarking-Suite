...
WHERE cct1.kind = 'complete'
    ...
    AND k.keyword in ('bunny-costume','female-explicit-nudity','downtown','code-breaking','psychological-drama','egg-donor','2000s','hill-farmer','silversmith','death-of-protagonist')
    AND kt.kind in ('episode','tv movie','video movie','video game','movie','tv mini series','video movie')
    AND mi.note like '%m Festival%'
    AND mi.info like '%0%'
