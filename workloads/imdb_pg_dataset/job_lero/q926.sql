...
WHERE cct1.kind = 'cast'
    ...
    AND ( chn.name like '%ir%'
    OR chn.name like '%ir%' )
    AND it2.info = 'rating'
    AND k.keyword in ( 'backstage','lifting-someone-into-the-air','crime-writer','burial-at-sea','reference-to-chester-w.-nimitz','opera-singing','40-year-old','rucksack','water-scooter','strong-sexual-content' )
