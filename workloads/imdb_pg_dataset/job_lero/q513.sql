...
WHERE cct1.kind = 'crew'
    ...
    AND it2.info = 'votes'
    AND kt.kind in ('tv series','video game','tv movie','video movie','tv movie','episode','tv movie')
    AND mc.note not like '% (USA)%'
    AND mi.info not IN ('28','Drama','Color','USA:2 April 2007','UK:PG','Short','Color','USA:15 March 2012','South Korea:15')
    AND mi_idx.info > '....3...15'
