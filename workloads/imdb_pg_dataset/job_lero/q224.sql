...
WHERE cct1.kind = 'crew'
    ...
    AND it1.info = 'LD analog right'
    AND it2.info = 'top 250 rank'
    AND kt.kind in ('video movie','episode','movie','tv mini series','video movie','tv movie')
    AND mc.note not like '%th%'
    AND mi.info not IN ('Mexico','France','PFM:16 mm','Australia:G','USA','English','Spain:30 December 2005','Canada')
    AND mi_idx.info > '112'
