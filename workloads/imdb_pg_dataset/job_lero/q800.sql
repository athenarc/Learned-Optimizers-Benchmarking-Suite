...
WHERE cct1.kind = 'cast'
    ...
    AND it1.info = 'novel'
    AND it2.info = 'rating'
    AND kt.kind in ('tv series','video movie','video game','tv mini series','video game','tv movie','tv series','video movie','episode')
    AND mc.note not like '%eatr%'
    AND mi.info not IN ('USA:8 September 2009','USA:R','Germany:12','English','Punjabi','English','English','Color')
    AND mi_idx.info > '29'
