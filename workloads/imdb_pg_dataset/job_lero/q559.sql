...
WHERE cn.country_code != '[de]'
    ...
    AND k.keyword = 'killing-a-dog'
    AND lt.link LIKE '%%'
    AND mc.note IS NULL
    AND mi.info IN ('Black
    AND White','Color','Arenys de Mar, Barcelona, Cataluña, Spain','New York City, New York, USA','PFM:35 mm','Thriller','English','Canada:G')
    AND t.production_year BETWEEN 1948
    AND 2012
