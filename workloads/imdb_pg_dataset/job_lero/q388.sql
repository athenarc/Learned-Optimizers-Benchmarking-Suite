...
WHERE cn1.country_code = '[ca]'
    AND it1.info = 'votes'
    AND it2.info = 'votes'
    AND kt1.kind in ('video game','tv movie','video movie','tv series','tv series','tv series','episode','video movie','video movie')
    AND kt2.kind in ('video game','tv movie','video movie','tv series','tv series','tv series','episode','video movie','video movie')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '4.3'
    AND t2.production_year = 2009
