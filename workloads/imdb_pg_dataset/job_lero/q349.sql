...
WHERE cct1.kind = 'cast'
    ...
    AND it1.info = 'LD additional information'
    AND it2.info = 'rating'
    AND kt.kind in ('tv movie','video game','movie','tv series','movie','tv movie','video game','video movie')
    AND mc.note not like '%m%'
    AND mi.info not IN ('Drama','USA','Argentina','Black
    AND White','USA:29 June 2009','UK:7 October 2010','Black
    AND White')
    AND mi_idx.info > '7.4'
