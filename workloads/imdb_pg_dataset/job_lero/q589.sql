...
WHERE cct1.kind = 'crew'
    ...
    AND it2.info = 'votes'
    AND kt.kind in ('episode','tv series','video movie','movie','movie','tv movie','episode','tv movie')
    AND mc.note not like '%VD)%'
    AND mi.info not IN ('MET:','Color','English','New York City, New York, USA','Dolby Digital','44','PFM:35 mm','France','Dolby Digital')
    AND mi_idx.info > '1.00011102'
