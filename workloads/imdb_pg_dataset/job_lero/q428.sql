...
WHERE cct1.kind = 'cast'
    ...
    AND kt.kind in ('episode','video movie','video game','tv series','video movie','movie')
    AND mc.note not like '%USA) (%'
    AND mi.info not IN ('English','7','Color','PCS:Spherical','Horror')
    AND mi_idx.info > '0..0..0007'
