...
WHERE cn1.country_code = '[jp]'
    AND it1.info = 'votes distribution'
    AND it2.info = 'votes distribution'
    AND kt1.kind in ('tv series','tv movie','tv series','tv series','video movie')
    AND kt2.kind in ('tv series','tv movie','tv series','tv series','video movie')
    AND lt.link LIKE '%%'
    AND mi_idx2.info < '470'
    AND t2.production_year = 2004
