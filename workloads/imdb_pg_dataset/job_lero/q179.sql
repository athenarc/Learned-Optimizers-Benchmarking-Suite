...
WHERE ci.note in ( '(executive producer)','(asst. production coordinator)','(writer)','(Winner)','(voice) (uncredited)','(story)','(uncredited)','(head writer)','(executive producer)','(2007)' )
    ...
    AND n.name like '%Ang%'
    AND rt.role = 'actress'
    AND t.production_year between 2004
    AND 2012
