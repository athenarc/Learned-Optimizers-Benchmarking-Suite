...
WHERE cct1.kind = 'crew'
    ...
    AND it2.info = 'rating'
    AND kt.kind in ('video game','tv movie','video movie','episode','tv mini series','movie','video game','tv series')
    AND mc.note not like '%TV) (broadcast premi%'
    AND mi.info not IN ('RAT:1.37 : 1','Belgium:KT','Color','USA:10 October 2012','USA','Poland','USA','Tamil')
    AND mi_idx.info > '7.2'
