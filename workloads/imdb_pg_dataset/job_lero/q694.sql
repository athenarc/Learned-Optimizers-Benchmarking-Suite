...
WHERE cct1.kind in ('complete+verified','cast','complete+verified','crew')
    ...
    AND lt.link LIKE '%erenced%'
    AND mc.note IS NULL
    AND mi.info IN ('Mono','English','Spanish','Thailand','Documentary','Color','Sweden:10','USA:25 September 2012','India','Color')
    AND t.production_year between 1968
    AND 2004
