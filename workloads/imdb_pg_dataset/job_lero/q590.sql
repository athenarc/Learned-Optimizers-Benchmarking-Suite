...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('pacific-island','24-hour-time-period','cowboys-and-indians','death-by-stoning','britney-spears','crazy-father')
    AND kt.kind in ('video movie','video game','movie','tv mini series')
    AND mi.note like '%st%'
    AND mi.info like '%%'
