...
WHERE ci.note in ( '(office production assistant)','(written by)','(voice)','(uncredited)','(voice: English version)','(voice)','(production assistant)','(executive producer)','(2012)','(creator)' )
