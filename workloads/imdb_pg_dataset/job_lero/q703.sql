...
WHERE ci.note in ( '(location manager) (as Robert L. Dunson)','(set production assistant)','(credit only)','(executive producer)','(production assistant) (uncredited)','(uncredited)' )
