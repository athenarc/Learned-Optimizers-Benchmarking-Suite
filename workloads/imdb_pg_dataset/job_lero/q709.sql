...
WHERE cct1.kind = 'crew'
    ...
    AND k.keyword in ( 'child-sneaks-out-of-house','interracial-marriage','riding-an-elephant','neglect','atlas-missile','eating-pigeon','tax-evader','loch-ness-monster','shot-multiple-times','meat' )
    AND kt.kind = 'movie'
