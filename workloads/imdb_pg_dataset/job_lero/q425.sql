...
WHERE cct1.kind = 'cast'
    ...
    OR chn.name like '% J%' )
    AND it2.info = 'rating'
    AND k.keyword in ( 'murder-of-king','mad-scientist','year-481','mother-in-law-son-in-law-relationship','bird-costume','cowl','santa-claus-suit','cosplay','labor-dispute','21st-century' )
