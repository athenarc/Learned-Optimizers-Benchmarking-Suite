...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('theatre-audience','monarchy','covering-ears-with-hands','going-insane')
    AND kt.kind in ('movie','movie','video game','tv mini series','tv series','tv mini series')
    AND mi.note like '%ilm Festi%'
    AND mi.info like '%%'
