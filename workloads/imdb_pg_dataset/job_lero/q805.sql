...
WHERE cct1.kind = 'cast'
    ...
    AND it2.info = 'rating'
    AND kt.kind in ('tv movie','video game','movie','video game','tv series','tv movie')
    AND mc.note not like '%many%'
    AND mi.info not IN ('Brampton, Ontario, Canada','Iceland:12','USA:28 January 2003','Short')
    AND mi_idx.info > '0000112110'
