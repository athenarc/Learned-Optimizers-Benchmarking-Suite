...
WHERE cct1.kind = 'complete'
    ...
    AND k.keyword in ('sole-black-character-dies-cliche','video-blog','mutated-animal','western-town','cayman-islands','can-of-gasoline','celery','taxidermist')
    AND kt.kind in ('movie','tv movie','tv movie','tv mini series','movie')
    AND mi.note like '%%'
    AND mi.info like '%%'
