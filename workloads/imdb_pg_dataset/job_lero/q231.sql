...
WHERE cct1.kind = 'complete+verified'
    ...
    AND k.keyword in ('goodwill','ice-fishing','pet-lizard','adopted-son','soccer-coach','art-thief','african-american-lesbian','hippo-regius','criminal-lineup')
    AND kt.kind in ('video movie','video movie','episode','tv movie','tv movie','tv series')
    AND mi.note like '%r%'
    AND mi.info like '%%'
