...
def evaluate_and_store_qep(path: str, query_name: str, hint_set: HintSet, connection_string: str, timeout: Opt[float]) -> Optional[float]:
    """
    ...
    try:
        ...
        plan_output_path = os.path.join(output_dir, f"{query_name}_fastgres_plan.json")
