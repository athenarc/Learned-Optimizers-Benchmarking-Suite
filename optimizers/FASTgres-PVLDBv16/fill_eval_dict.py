...
def run():
    ...
    elif args_dbi == "stack-2019":
        args_dbinfo = u.PG_STACK_OVERFLOW_REDUCED_19
    elif args_dbi == "stack-2015":
        args_dbinfo = u.PG_STACK_OVERFLOW_REDUCED_15
    elif args_dbi == "stack-2011":
        args_dbinfo = u.PG_STACK_OVERFLOW_REDUCED_11
    elif args_dbi == "tpch":
        args_dbinfo = u.PG_TPC_H
    elif args_dbi == "tpcds":
        args_dbinfo = u.PG_TPC_DS
    elif args_dbi == "ssb":
        args_dbinfo = u.PG_SSB        
    else:
