...
AND (t1.name in ('abstract-algebra','category-theory','command-line','complex-analysis','differential-geometry','elementary-set-theory','functions','networking','probability','server'))
