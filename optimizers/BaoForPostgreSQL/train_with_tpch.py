...
USE_BAO = True
PG_CONNECTION_STR = "dbname=tpch user=suite_user host=train.darelab.athenarc.gr port=5469 password=71Vgfi4mUNPm"
...
def save_final_model_and_history():
    ...
    # Configuration
    model_dir = "/data/hdd1/users/kmparmp/models/bao/tpc-h"
