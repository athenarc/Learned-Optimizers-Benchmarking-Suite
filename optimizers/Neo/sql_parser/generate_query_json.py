...
def read_queries_from_directory(directory: str) -> List[str]:
    """Read SQL queries from files in the specified directory."""
    queries = []
    queryNames = []
...
def generate_final_json(queries_dir: str, conn, test_size: float = 0.0) -> Dict[str, Any]:
    """Generate the complete JSON output with train/test split"""
    # Read all queries from directory
