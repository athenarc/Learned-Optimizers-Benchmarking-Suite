...
AND (t1.name in ('bitbucket-pipelines','custom-view','dashdb','detox','floating','headless-browser','listboxitem','long-polling','offline-caching','platform','pmd','snowflake-datawarehouse'))
