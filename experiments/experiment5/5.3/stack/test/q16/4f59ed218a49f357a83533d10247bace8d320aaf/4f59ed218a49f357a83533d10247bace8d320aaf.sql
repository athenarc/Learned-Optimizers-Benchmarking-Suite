...
AND (t1.name in ('dynamics-crm-2013','es6-modules','gdal','java-bytecode-asm','mozilla','msysgit','opengraph','preferences','string-literals','type-erasure','yahoo-finance','yii2-advanced-app'))
