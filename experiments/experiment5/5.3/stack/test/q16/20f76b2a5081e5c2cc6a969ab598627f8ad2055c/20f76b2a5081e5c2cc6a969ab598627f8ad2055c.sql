...
AND (t1.name in ('add','angular-reactive-forms','arabic','biginteger','copy-constructor','elixir','jquery-plugins','linker-errors','many-to-many','mod-rewrite','shell','smtp','sprite-kit','uuid','xml'))
