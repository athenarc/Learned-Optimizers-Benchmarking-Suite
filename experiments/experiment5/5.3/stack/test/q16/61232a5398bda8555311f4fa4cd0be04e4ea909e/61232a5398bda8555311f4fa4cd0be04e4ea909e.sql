...
AND (t1.name in ('angular-ng-if','anti-patterns','authorize.net','blade','entity-attribute-value','flux','macos-mojave','macports','sentiment-analysis','solution','substr','tableau','xcode4.5'))
