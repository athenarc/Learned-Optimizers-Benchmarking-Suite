...
AND (t1.name in ('azure-virtual-machine','duration','email-attachments','endpoint','google-apps','import-from-excel','influxdb','kohana','nat','preferences','scala-2.10','tvos','virtual-memory'))
