...
AND (t1.name in ('activeadmin','analytics','bootstrap-4','combinations','currency','distributed','events','field','gunicorn','highlight','lisp','memory','ms-access-2010','objective-c','startup'))
