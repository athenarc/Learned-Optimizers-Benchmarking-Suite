...
AND (t1.name in ('apache-spark','css','dictionary','express','geospatial','itextsharp','kinect','manifest','mp3','oracle11g','osx-yosemite','paypal-sandbox','pyqt4','right-to-left','tcp'))
