...
AND (t1.name in ('biztalk','epplus','gamekit','ghci','hpc','hyperledger-composer','jquery-file-upload','jshint','lapply','overlap','portlet','swiftmailer','torch','voice-recognition','zoo'))
