...
AND (t1.name in ('artificial-intelligence','collision-detection','download','doxygen','embed','firebug','materialize','memory-leaks','object','sharepoint-2010','teamcity','visual-studio-2010'))
