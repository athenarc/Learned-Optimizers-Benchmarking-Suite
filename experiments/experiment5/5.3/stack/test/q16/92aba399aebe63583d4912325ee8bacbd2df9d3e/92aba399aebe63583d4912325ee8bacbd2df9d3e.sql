...
AND (t1.name in ('commit','entity-framework-4.1','google-visualization','gsm','jsf','media-player','microcontroller','quartz-graphics','systemjs','tomcat','torch','ubuntu-12.04','war'))
