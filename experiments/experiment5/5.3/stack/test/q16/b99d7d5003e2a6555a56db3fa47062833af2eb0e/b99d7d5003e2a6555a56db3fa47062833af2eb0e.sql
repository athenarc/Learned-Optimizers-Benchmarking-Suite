...
AND (t1.name in ('android','entity','facebook-javascript-sdk','function','laravel-5.1','memcached','popup','raspberry-pi','recursion','return-value','scroll','tokenize','tooltip','wpf'))
