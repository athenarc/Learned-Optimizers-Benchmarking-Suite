...
AND (t1.name in ('audio-player','cryptoapi','devtools','firebaseui','jquery-ui-tabs','mootools','ms-media-foundation','responsive','ribbon','uitouch','vb.net-2010','web-frameworks'))
