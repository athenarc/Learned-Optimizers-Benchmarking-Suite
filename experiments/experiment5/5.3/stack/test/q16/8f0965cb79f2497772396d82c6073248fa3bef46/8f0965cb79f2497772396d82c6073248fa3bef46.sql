...
AND (t1.name in ('android-architecture-components','datetimepicker','dropbox','edit','emacs','kinect','lstm','oauth','photoshop','posix','remote-access','smart-pointers','substring','variables'))
