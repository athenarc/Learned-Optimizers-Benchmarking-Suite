...
AND (t1.name in ('alignment','bluetooth-lowenergy','command-prompt','google-chrome-extension','graph','iframe','office-interop','react-jsx','statistics','stream','xml-parsing','xsd','zip'))
