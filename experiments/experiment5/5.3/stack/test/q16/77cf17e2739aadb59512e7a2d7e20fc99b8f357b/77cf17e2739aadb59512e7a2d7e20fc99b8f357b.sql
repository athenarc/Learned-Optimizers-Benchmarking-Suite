...
AND (t1.name in ('air','android-permissions','boost','border','cygwin','distributed-computing','google-maps-android-api-2','groovy','jax-ws','outlook-addin','python-3.x','typeerror','wear-os'))
