...
s1.site_name='civicrm' and
t1.name in ('civimail', 'database', 'api', 'wordpress', 'civievent', 'civicontribute', 'webform-civicrm', 'contributions', 'contacts') and
