...
s1.site_name='ethereum' and
t1.name in ('tokens', 'synchronization', 'mist', 'contract-design', 'contract-deployment', 'contract-debugging', 'accounts') and
