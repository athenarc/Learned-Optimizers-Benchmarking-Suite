...
s1.site_name='datascience' and
t1.name in ('tensorflow', 'multiclass-classification', 'decision-trees', 'training', 'k-means', 'feature-selection', 'feature-extraction', 'classification') and
