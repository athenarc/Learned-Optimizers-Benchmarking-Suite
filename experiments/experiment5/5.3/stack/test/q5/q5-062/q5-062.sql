...
s1.site_name='aviation' and
t1.name in ('flight-controls', 'radio-communications', 'landing-gear', 'aeronautical-charts', 'accidents', 'takeoff', 'jet') and
