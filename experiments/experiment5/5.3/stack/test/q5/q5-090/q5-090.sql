...
s1.site_name='spanish' and
t1.name in ('verbos', 'tiempos-verbales', 'adjetivos', 'expresiones', 'traducción', 'solicitud-de-término', 'méxico', 'preposiciones') and
