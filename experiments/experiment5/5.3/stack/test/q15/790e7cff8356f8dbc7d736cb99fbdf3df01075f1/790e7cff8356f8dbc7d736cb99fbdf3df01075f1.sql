...
AND (t1.name in ('entire-functions','grep','kalman-filter','launchpad','locally-compact-groups','newton-raphson','openjdk','openvpn','perl','postfix','product-space','spectral-graph-theory','ubuntu-mate'))
