...
AND (t1.name in ('ceiling-function','fiber-bundles','jensen-inequality','libraries','locale','microphone','nets','network-flow','nodejs','openstack-autopilot','panel','symmetric-functions'))
