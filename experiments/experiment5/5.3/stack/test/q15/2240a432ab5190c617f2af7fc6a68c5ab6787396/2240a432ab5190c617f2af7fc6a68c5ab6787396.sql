...
AND (t1.name in ('asp.net-web-api2','biztalk','csv','filemaker','hidden','jface','matching','network-programming','plesk','plsqldeveloper','profiling','safari','sqlplus','svn','winsock'))
