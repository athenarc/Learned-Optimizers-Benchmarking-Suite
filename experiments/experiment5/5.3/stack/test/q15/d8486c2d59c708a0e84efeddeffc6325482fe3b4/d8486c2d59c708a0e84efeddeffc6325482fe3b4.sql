...
AND (s.site_name in ('apple','codereview','physics','serverfault'))
AND (t1.name in ('acoustics','astronomy','classical-mechanics','debian','group-theory','ssh','unit-testing','velocity'))
