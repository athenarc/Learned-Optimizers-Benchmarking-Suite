...
AND (t1.name in ('amd','android-custom-view','certificate','cpython','data-annotations','decompiling','graphics-card','microsoft-metro','sample','sql-server-2008-r2','tabs','tomcat7','web-crawler'))
