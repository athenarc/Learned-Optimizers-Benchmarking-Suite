...
AND (t1.name in ('amazon-ses','bitbucket-server','cql3','forecasting','openfire','polling','query-builder','text-classification','unhandled-exception','windows-media-player'))
