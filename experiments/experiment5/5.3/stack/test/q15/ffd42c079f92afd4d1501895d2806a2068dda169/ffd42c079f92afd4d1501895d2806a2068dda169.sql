...
AND (t1.name in ('agent','awk','connection','context-free-grammar','copy','desktop','fiddler','google-translate','impala','mechanize','phpexcel','setinterval','ssl','typoscript','unique'))
