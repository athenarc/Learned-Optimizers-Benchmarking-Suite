...
AND (s.site_name in ('ell','gaming','mathematica','money','security'))
AND (t1.name in ('cryptography','differential-equations','front-end','hash','privacy','programming','united-states'))
