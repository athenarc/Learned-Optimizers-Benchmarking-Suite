...
AND (t1.name in ('android-4.0-ice-cream-sandwich','android-cardview','composite-primary-key','delete-row','frontend','rmagick','smart-pointers','sorting','spring-data-mongodb'))
