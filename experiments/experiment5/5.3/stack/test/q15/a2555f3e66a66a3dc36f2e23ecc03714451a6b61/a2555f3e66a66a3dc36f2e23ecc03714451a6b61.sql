...
AND (t1.name in ('dd','encoding','external-display','kernel','libreoffice-calc','microsoft-word-2007','opera','plugins','postfix','uac','ubuntu-12.04','video-conversion','windows-media-player'))
