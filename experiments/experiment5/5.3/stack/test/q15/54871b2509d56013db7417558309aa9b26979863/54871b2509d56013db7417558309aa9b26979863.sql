...
AND (s.site_name in ('dba','es','magento','math','unix'))
AND (t1.name in ('collection','covering-spaces','product-attribute','sales-order','samba','theme','topological-groups','vector-fields'))
