...
AND (t1.name in ('amazon-web-services','backup','computer-building','ipv6','keyboard-layout','lan','microsoft-powerpoint','network-shares','power','proxy','python','troubleshooting','vba'))
