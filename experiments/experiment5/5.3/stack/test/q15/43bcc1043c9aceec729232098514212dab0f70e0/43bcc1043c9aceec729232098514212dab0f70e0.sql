...
AND (t1.name in ('algebraic-number-theory','compactness','conjectures','differential-forms','expectation','fibonacci-numbers','graphing-functions','matrix-equations','model-theory','permutations','set-theory'))
