...
AND (s.site_name in ('ell','scifi','softwareengineering','webapps','wordpress'))
AND (t1.name in ('adverbs','google-account','google-calendar','subject-verb-agreement','translation'))
