...
AND (s.site_name in ('diy','webmasters','wordpress'))
AND (t1.name in ('admin','comments','css','hooks','html','https','pages','redirect','redirects','security','taxonomy','templates','wp-admin'))
