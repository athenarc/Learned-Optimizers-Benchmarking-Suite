...
AND (s.site_name in ('askubuntu','magento','stackoverflow'))
AND (t1.name in ('base64','documentation','git-branch','gridview','html5-video','log4j','nautilus','spring-data-jpa','youtube-api'))
