...
AND (t1.name in ('10.10','compiling','crash','display-resolution','filesystem','java','login','mouse','mysql','nautilus','shortcut-keys','software-recommendation','system-installation','vpn'))
