...
AND (t1.name in ('character-encoding','complexity-theory','crystal-reports','eclipse-rcp','manifest','mapreduce','object','paramiko','retrofit','sorting','uiimagepickercontroller','win-universal-app'))
