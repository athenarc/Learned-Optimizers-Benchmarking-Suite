...
AND (t1.name in ('airflow','composite-component','dependency-management','dst','dtd','kafka-producer-api','linker-errors','nsis','playback','pyserial','random','saml-2.0','userform'))
