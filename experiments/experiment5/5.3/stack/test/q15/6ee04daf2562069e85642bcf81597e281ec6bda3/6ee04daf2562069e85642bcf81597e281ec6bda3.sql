...
AND (s.site_name in ('apple','askubuntu','codereview','physics','unix'))
AND (t1.name in ('authentication','cosmology','filenames','io-redirection','lubuntu','mac','monitoring','random','skype'))
