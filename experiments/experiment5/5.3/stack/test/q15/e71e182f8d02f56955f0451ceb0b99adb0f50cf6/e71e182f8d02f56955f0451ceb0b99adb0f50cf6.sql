...
AND (t1.name in ('ckeditor4.x','cloudinary','coverage.py','evaluate','exoplayer2.x','ftps','laravel-socialite','maven-dependency-plugin','mod-security','networkd3','opencsv','processor','rowfilter'))
