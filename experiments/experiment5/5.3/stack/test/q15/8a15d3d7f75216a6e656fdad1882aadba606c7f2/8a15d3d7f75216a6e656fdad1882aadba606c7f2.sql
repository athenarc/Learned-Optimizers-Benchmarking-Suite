...
AND (t1.name in ('android-6.0-marshmallow','assert','compiler-warnings','extension-methods','jinja2','linear-regression','mvvm','nhibernate-mapping','output','resources','spring-integration','tar'))
