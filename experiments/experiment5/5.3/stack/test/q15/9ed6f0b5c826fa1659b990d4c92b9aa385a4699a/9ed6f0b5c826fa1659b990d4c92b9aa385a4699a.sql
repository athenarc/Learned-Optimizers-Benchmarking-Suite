...
AND (t1.name in ('azure-eventhub','blogspot','google-play-console','html-framework-7','hybrid','mutation-observers','postcss','preprocessor-directive','ref','sunburst-diagram','uid'))
