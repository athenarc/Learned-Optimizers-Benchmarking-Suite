...
AND (s.site_name in ('chemistry','ell','gamedev','graphicdesign','security'))
AND (t1.name in ('authentication','c++','cryptography','encryption','game-design','passwords','web-application'))
