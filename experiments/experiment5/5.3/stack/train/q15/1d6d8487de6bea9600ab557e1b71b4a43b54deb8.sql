...
AND (t1.name in ('algorithms','determinant','fourier-analysis','graph-theory','keyboard','ordinary-differential-equations','pde','proof-writing','ssh','statistics','stochastic-processes'))
