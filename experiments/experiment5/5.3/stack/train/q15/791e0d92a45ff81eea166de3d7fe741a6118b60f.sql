...
AND (t1.name in ('catalan-numbers','colors','filemanager','hibernate','implicit-function-theorem','legendre-symbol','pattern-recognition','playonlinux','principal-ideal-domains','uniform-integrability','webserver'))
