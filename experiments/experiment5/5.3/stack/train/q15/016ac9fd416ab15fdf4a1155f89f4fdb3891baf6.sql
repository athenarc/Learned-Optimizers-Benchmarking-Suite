...
AND (t1.name in ('asymptotics','cdf','count-data','dimensionality-reduction','distributions','exponential','goodness-of-fit','heteroscedasticity','mixed-model','modeling','panel-data','prior','seasonality'))
