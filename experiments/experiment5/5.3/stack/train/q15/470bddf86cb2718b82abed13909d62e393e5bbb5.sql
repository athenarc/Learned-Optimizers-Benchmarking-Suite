...
AND (t1.name in ('amazon-cloudwatch','bigdecimal','client-side','coldfusion-10','lexer','multi-index','quickbooks','sml','spyder','system.drawing','tabular','tail','uipangesturerecognizer','video-encoding'))
