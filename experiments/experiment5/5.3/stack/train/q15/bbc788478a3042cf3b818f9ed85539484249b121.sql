...
AND (s.site_name in ('es','math','pt','tex','unix'))
AND (t1.name in ('fonts','multivariable-calculus','ordinary-differential-equations','recreational-mathematics','shell-script'))
