...
AND (t1.name in ('ag-grid','chess','cpu-cache','decltype','handle','indexof','lock-free','multiplayer','oracle-adf','rectangles','rounded-corners','silverlight-3.0','solrj','stringbuilder','upsert'))
