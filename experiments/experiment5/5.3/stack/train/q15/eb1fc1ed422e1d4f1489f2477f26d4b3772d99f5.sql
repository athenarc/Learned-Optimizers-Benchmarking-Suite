...
AND (t1.name in ('analysis','binomial-coefficients','combinatorics','convergence','gnome','intuition','measure-theory','sequences-and-series','soft-question','software-recommendation','special-functions'))
