...
AND (t1.name in ('compact-framework','computational-geometry','fullscreen','global-variables','indentation','linker','menu','npgsql','replace','servlets','spring-batch','sql-server-2008','vue-component','xaml'))
