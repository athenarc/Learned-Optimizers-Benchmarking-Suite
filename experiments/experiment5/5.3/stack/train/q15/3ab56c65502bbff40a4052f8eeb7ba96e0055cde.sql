...
AND (t1.name in ('17.04','conjectures','connectedness','determinant','filters','fractals','gui','hard-drive','hp','improper-integrals','normed-spaces','polar-coordinates','ppa','sequences-and-series'))
