...
AND (t1.name in ('exchange-2003','fedora','filesystems','google-compute-engine','high-availability','mod-rewrite','node.js','rsync','smtp','software-raid','sql','virtual-machines'))
