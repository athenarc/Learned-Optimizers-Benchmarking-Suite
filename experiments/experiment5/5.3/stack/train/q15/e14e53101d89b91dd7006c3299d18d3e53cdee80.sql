...
AND (t1.name in ('analysis','contour-integration','dual-boot','education','examples-counterexamples','foundations','fourier-series','gamma-function','irrational-numbers','package-management','python','random-walk','uefi'))
