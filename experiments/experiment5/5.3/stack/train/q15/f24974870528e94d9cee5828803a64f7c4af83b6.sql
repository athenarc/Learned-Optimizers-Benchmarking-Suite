...
AND (t1.name in ('17.10','android','euclidean-geometry','expectation','foundations','kde','lie-groups','problem-solving','products','python','real-analysis','riemann-integration','ring-theory','samba'))
