...
AND (t1.name in ('14.04','16.04','apt','bash','boot','command-line','gnome','networking','package-management','shortcut-keys','software-installation','software-recommendation','ssh','unity','wireless'))
