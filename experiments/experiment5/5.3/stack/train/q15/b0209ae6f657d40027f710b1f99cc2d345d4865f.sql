...
AND (t1.name in ('angular-ui','charts','commit','decorator','entity-relationship','flexbox','google-chrome','google-chrome-devtools','graph-algorithm','orm','pthreads','requirejs','textfield','width'))
