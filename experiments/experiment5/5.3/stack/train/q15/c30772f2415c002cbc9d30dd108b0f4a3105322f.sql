...
AND (t1.name in ('axiom-of-choice','banach-spaces','complex-geometry','congruences','continuity','fourier-series','linear-algebra','nonlinear-optimization','vector-bundles'))
