...
AND (t1.name in ('actionlistener','android-activity','azure-sql-database','bioinformatics','build-automation','bytearray','delete-file','google-bigquery','matlab','paint','rdf','visual-studio','warnings','wireless-networking'))
