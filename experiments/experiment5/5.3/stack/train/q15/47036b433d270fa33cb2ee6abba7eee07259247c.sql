...
AND (t1.name in ('eclipse-pdt','f#-data','hittest','httpwebresponse','microsoft-office-2010','pem','poisson','proc-sql','resx','scrum','sqlcmd','squeak','uiswipegesturerecognizer'))
