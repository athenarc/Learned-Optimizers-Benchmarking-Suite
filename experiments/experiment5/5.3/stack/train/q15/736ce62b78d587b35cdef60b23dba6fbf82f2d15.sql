...
AND (t1.name in ('android-c2dm','android-dialog','android-pendingintent','aptana','factory-pattern','form-submit','labels','lexer','organization','puma','sql-server-data-tools','vector-graphics','vert.x'))
