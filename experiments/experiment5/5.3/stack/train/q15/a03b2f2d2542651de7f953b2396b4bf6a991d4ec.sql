...
AND (t1.name in ('app-store','asihttprequest','cucumber','elements','exchange-server','fill','google-api-java-client','google-cloud-platform','memory-leaks','reboot','sugarcrm','timespan','visual-studio-code'))
