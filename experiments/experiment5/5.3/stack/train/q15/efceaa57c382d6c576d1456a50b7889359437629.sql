...
AND (s.site_name in ('blender','chemistry','cs','gamedev','judaism'))
AND (t1.name in ('electrochemistry','halides','kinetics','names','reductions','runtime-analysis','talmud-gemara','words'))
