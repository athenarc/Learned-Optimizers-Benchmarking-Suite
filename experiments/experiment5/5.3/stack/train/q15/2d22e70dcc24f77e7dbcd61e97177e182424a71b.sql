...
AND (s.site_name in ('diy','security'))
AND (t1.name in ('anonymity','brute-force','chrome','cookies','gnupg','google','known-vulnerabilities','nmap','physical','virtualization','wireless'))
