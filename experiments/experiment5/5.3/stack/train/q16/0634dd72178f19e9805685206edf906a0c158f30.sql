...
AND (t1.name in ('android-tv','angularjs-filter','azure-web-roles','elmah','getjson','google-glass','mac-address','pull','shutdown','spring-hateoas','tablesorter','tfs2013','uipagecontrol'))
