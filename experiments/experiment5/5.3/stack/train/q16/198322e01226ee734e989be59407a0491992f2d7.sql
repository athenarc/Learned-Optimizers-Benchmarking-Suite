...
AND (t1.name in ('arm','asp.net-identity','attributes','clang','cocoapods','concatenation','gulp','header','jboss','multiprocessing','ocr','python-2.x','retrofit','signals','unity3d'))
