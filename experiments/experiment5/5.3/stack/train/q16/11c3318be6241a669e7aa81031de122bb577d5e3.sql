...
AND (t1.name in ('apdu','avaudiorecorder','durandal','embedded-jetty','event-loop','extern','gdata-api','image-rotation','rust-cargo','self-signed','streamwriter','uppercase','userscripts'))
