...
AND (t1.name in ('crashlytics','dependency-injection','django-models','e-commerce','embedded-linux','fortran','google-sheets','meteor','mpi','phone-call','rx-java2','system','traits'))
