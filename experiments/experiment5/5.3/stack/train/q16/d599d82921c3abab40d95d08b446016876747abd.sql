...
AND (t1.name in ('amazon-ec2','android-ndk','bit-manipulation','d3.js','directory','google-maps','gradle','grep','javascript-events','kotlin','multithreading','oracle','terminal','web','xcode6'))
