...
AND (t1.name in ('cell-array','coordinate-transformation','datacontract','dreamweaver','extraction','introspection','lamp','scrollviewer','shiro','uisegmentedcontrol','wix3.5','xlsxwriter'))
