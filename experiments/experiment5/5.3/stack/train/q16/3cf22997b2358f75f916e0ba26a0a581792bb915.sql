...
AND (t1.name in ('android-support-library','ansible','count','flexbox','gem','gruntjs','onclick','parameter-passing','phpstorm','rsa','uinavigationcontroller','wolfram-mathematica'))
