...
AND (t1.name in ('.net-core','artificial-intelligence','azure','compiler-optimization','config','contextmenu','dataframe','jquery-select2','netbeans','powerbi','xamarin.android'))
