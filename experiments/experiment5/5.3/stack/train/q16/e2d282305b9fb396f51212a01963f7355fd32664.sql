...
AND (t1.name in ('apache-flex','apache-spark','cross-platform','f#','google-chrome-extension','gorm','keyboard-shortcuts','responsive-design','stdin','structure','validation','web-services'))
