...
AND (t1.name in ('android-constraintlayout','css','django-templates','firefox-addon','ibm-mq','licensing','logical-operators','mechanize','multi-tenant','product','reduce','rstudio','rxjs5','share'))
