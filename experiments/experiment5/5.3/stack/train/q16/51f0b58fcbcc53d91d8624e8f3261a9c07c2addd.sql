...
AND (t1.name in ('android-manifest','binding','command-line','data-science','decimal','delphi-2009','dockerfile','histogram','ios4','overflow','scala-collections','viewcontroller','webbrowser-control'))
