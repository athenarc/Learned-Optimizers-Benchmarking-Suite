...
AND (t1.name in ('camera','css-tables','duplicates','firefox-addon','gruntjs','hibernate','mathematical-optimization','passenger','phonegap-plugins','pytorch','ruby','static','swagger','vim'))
