...
AND (t1.name in ('android-annotations','apc','azure-machine-learning-studio','blobstore','distributed-system','dockerhub','gamekit','leap-motion','pki','tensorflow.js','tsconfig'))
