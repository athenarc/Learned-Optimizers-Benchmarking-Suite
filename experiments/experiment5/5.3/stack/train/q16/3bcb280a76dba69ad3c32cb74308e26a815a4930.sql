...
AND (t1.name in ('amazon-s3','cil','crystal-reports','digital-ocean','google-app-maker','nsfetchedresultscontroller','programming-languages','sentiment-analysis','visual-studio-2015'))
