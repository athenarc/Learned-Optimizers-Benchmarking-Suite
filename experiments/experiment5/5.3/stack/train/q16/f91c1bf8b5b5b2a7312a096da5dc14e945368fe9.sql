...
AND (t1.name in ('charts','copy','doctrine-orm','google-maps-android-api-2','hive','httpwebrequest','javafx','moq','nltk','react-router','request','vi','webserver','windows-services','xamarin'))
