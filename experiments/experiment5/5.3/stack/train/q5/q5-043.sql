...
t1.name in ('volatility', 'stochastic-processes', 'garch', 'probability', 'interest-rates', 'optimization', 'stochastic-calculus', 'python', 'arbitrage') and
