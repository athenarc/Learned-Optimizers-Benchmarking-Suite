...
AND (t1.name in ('apache-spark-mllib','data-science','elastic-beanstalk','embed','iphone-sdk-3.0','keystore','multipartform-data','nstimer','python-sphinx','sdl','smarty','sse','zoom'))
