...
AND (t1.name in ('atom-editor','core-animation','datastax','embedded','exception','frontend','laravel-5.4','libcurl','local-storage','modal-dialog','mstest','openssl','pytest','rewrite','uwsgi'))
