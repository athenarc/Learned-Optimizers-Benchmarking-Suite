...
AND (t1.name in ('android-widget','count','ef-code-first','extjs','ftp','jupyter-notebook','media-queries','pattern-matching','refactoring','singleton','timestamp','xmlhttprequest','xsd'))
