...
AND (t1.name in ('analytics','android-recyclerview','checkbox','data-binding','datepicker','instance','magento','ms-access','set','traits','uicollectionview','visual-studio-code','wicket'))
