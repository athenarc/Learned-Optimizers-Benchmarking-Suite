...
AND (t1.name in ('amazon-web-services','cakephp-2.0','cart','compilation','elasticsearch','ios5','ipc','jquery-mobile','mouseevent','powershell-3.0','resteasy','shared-libraries','sparse-matrix','sum'))
