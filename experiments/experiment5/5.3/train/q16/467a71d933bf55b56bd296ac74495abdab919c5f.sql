...
AND (t1.name in ('artoolkit','concurrenthashmap','dart-editor','database-project','dot-product','hibernate-5.x','odoo-12','rollover','setup-deployment','uiaccessibility','upnp','yahoo-api'))
