...
AND (t1.name in ('android-activity','asp.net','database','database-design','ecmascript-6','jsf-2','layout','localization','mongoose','scala','scikit-learn','uiview','utf-8','vue.js','xaml'))
