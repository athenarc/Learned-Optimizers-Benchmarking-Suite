...
AND (t1.name in ('android-contacts','android-sdcard','atl','feed','fortran90','grid-layout','has-many','jsonpath','mql4','pywin32','spyder','system.drawing','text-mining','web-deployment'))
