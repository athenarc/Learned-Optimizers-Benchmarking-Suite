...
AND (s.site_name in ('blender','gaming','graphicdesign'))
AND (t1.name in ('achievements','curves','customization','cycles','faces','image','the-elder-scrolls-5-skyrim','vertices'))
