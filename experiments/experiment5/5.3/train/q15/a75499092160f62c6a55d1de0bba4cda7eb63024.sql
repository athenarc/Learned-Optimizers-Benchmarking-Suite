...
AND (t1.name in ('adapter','combinatorics','deep-learning','deserialization','opengl-es','playframework-2.0','reference','sqlite','valgrind','vim','wildfly','window','worksheet-function','xpages'))
