...
AND (t1.name in ('android-relativelayout','android-transitions','archlinux','dbus','dynamic-cast','eclipse-jdt','moose','pdb','phone-number','reactive-cocoa','spring-4','symfony-2.1'))
