...
AND (t1.name in ('12.04','14.04','16.04','apt','bash','command-line','networking','package-management','server','shortcut-keys','software-installation','software-recommendation','ssh','unity','wireless'))
