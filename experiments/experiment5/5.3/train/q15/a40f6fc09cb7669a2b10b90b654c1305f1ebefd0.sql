...
AND (t1.name in ('algorithms','education','general-topology','laurent-series','nonlinear-system','numerical-linear-algebra','regression','riemann-integration','stochastic-calculus'))
