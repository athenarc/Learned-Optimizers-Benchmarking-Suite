...
AND (t1.name in ('bios','drivers','encryption','graphics-card','hard-drive','memory','microsoft-outlook','microsoft-word','notepad++','ssd','ssh','video','windows-7','windows-8.1','worksheet-function'))
