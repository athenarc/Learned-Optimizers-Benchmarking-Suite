...
AND (t1.name in ('big-list','category-theory','combinations','control-theory','factoring','induction','laurent-series','matrix-decomposition','projective-space','random-walk','vector-analysis'))
