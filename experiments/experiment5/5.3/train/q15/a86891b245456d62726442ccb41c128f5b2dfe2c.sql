...
AND (s.site_name in ('english','magento','physics','unix'))
AND (t1.name in ('arch-linux','differentiation','gauge-theory','magento-1.7','newtonian-gravity','pronunciation','thermodynamics'))
