...
AND (t1.name in ('amazon-ecs','back-button','background-color','colorbox','instruments','interceptor','nvd3.js','qthread','regex-negation','rtf','shinydashboard','uialertview','vlc-media-player','windows-server-2008-r2','wsgi'))
