...
AND (s.site_name in ('apple','gis','salesforce','stackoverflow'))
AND (t1.name in ('delphi-10.1-berlin','flask-login','hornetq','rasterio','sqldependency','stocks','stringtokenizer'))
