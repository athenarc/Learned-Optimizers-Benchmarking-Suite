...
AND (t1.name in ('accessibility','datastax-enterprise','deserialization','jruby','laptop','linkedin','pinvoke','refactoring','selenium-webdriver','stm32','tcl','viewmodel','visual-studio-2017','webclient','xcode5'))
