...
AND (t1.name in ('android-preferences','api-design','app-engine-ndb','boto3','division','expo','gitlab-ci','interrupt','monitor','mpandroidchart','rtp','symfony-forms','tidyr','truncate'))
