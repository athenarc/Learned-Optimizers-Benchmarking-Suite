...
AND (t1.name in ('azure-batch','background-service','castle-activerecord','dji-sdk','dyld','folding','generic-collections','msbi','ng-animate','obiee','prestashop-1.7','sicp','wildfly-9'))
