...
AND (t1.name in ('automation','backbone.js','crm','delphi-xe2','eclipselink','flexbox','java-native-interface','linq','multiple-columns','nspredicate','phonegap-plugins','scp','struts2'))
