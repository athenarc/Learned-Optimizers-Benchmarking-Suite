...
AND (t1.name in ('cygwin','data-recovery','debian','display','dns','ftp','graphics-card','keyboard-layout','keyboard-shortcuts','microsoft-excel','mouse','pdf','python','raid','windows-registry'))
