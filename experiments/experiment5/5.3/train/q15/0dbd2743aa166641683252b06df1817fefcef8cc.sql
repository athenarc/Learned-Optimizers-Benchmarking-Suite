...
AND (t1.name in ('android-mediaplayer','combobox','conditional','customization','doctrine-orm','forms-authentication','lstm','manifest','menu','swig','triggers','updates','whitespace'))
